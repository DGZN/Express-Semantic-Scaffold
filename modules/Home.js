    ...
    return (
      <div>
        ...
        <div className="ui vertical center container aligned grids">
          <Carousel title="Movies" source="/movies" language={this.state.language} limit="10" href="/movies/:id" />
          <Carousel title="Series" source="/series" language={this.state.language} limit="10" href="/series/:id" />
          <Carousel title="Plays"  source="/plays" language={this.state.language}  limit="10" href="/plays/:id" />
        </div>
      </div>
    );
  }
