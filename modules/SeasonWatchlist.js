...
export default React.createClass({
  render() {
    ...
    this.props.episodes.map((episode, i) => {
      ROWS.push(<WatchlistRow key={'watchlist-'+i} episode={episode} language={this.props.language} {...this.props} />)
    })
    // setTimeout(function(){
    ...
    return (
      <div className="row watchlist">
        <div className="sixteen wide tablet four wide computer column tight-right">
          ...
          <span className="watchlist-button">{local.ep + ' '}{this.props.episode.episode_number}</span>
        </div>
