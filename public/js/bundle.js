...
/******/return __webpack_require__(0); /******/})( /************************************************************************/ /******/[ /* 0 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var ReactDOM=__webpack_require__(158);var App=__webpack_require__(159);var Grid=__webpack_require__(170);var Footer=__webpack_require__(169);var GridApp=__webpack_require__(173);var HomeApp=__webpack_require__(174);var MyAccount=__webpack_require__(160);var SeasonApp=__webpack_require__(177);var AlbumDetail=__webpack_require__(183);var VideoDetail=__webpack_require__(164);var SimilarTitles=__webpack_require__(168);if($('#home').length){ReactDOM.render(React.createElement(HomeApp,null),document.getElementById('home'));}if($('#movies').length){ReactDOM.render(React.createElement(GridApp,{title:"Movies",source:"/movies",limit:"5",href:"/movies/:id"}),document.getElementById('movies'));}if($('#movie').length){var movie='/movies/'+$('#movie').data('id');ReactDOM.render(React.createElement(App,{source:movie}),document.getElementById('movie'));}if($('#series').length){ReactDOM.render(React.createElement(GridApp,{title:"Series",source:"/series",limit:"5",href:"/series/:id"}),document.getElementById('series'));}if($('#season').length){var season='/series/'+$('#season').data('id');ReactDOM.render(React.createElement(SeasonApp,{source:season}),document.getElementById('season'));}if($('#music').length){ReactDOM.render(React.createElement(GridApp,{title:"Music",source:"/albums",limit:"5",href:"/albums/:id",thumbPath:"songs"}),document.getElementById('music'));}if($('#album-details').length){var album='/albums/'+$('#album-details').data('id');ReactDOM.render(React.createElement(AlbumDetail,{source:album}),document.getElementById('album-details'));}if($('#plays').length){ReactDOM.render(React.createElement(GridApp,{title:"Plays",source:"/plays",limit:"5",href:"/plays/:id"}),document.getElementById('plays'));}if($('#play').length){var play='/plays/'+$('#play').data('id');ReactDOM.render(React.createElement(App,{source:play}),document.getElementById('play'));}if($('#footer').length){ReactDOM.render(React.createElement(Footer,null),document.getElementById('footer'));} /***/}, /* 1 */ /***/function(module,exports,__webpack_require__){'use strict';module.exports=__webpack_require__(2); /***/}, /* 2 */ /***/function(module,exports,__webpack_require__){ /**
...
return assign(newFn,fn);}return fn;}module.exports=deprecated; /* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(4)); /***/}, /* 158 */ /***/function(module,exports,__webpack_require__){'use strict';module.exports=__webpack_require__(3); /***/}, /* 159 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var MyAccount=__webpack_require__(160);var MyWatchlist=__webpack_require__(161);var Nav=__webpack_require__(163);var VideoDetail=__webpack_require__(164);var SimilarTitles=__webpack_require__(168);var Footer=__webpack_require__(169);var App=React.createClass({displayName:"App",setLanguage:function setLanguage(lang){this.setState({language:lang});},getInitialState:function getInitialState(){return {language:'en'};},render:function render(){return React.createElement("div",null,React.createElement(MyAccount,null),React.createElement(MyWatchlist,null),React.createElement(Nav,{setLanguage:this.setLanguage,language:this.state.language}),React.createElement(VideoDetail,React.__spread({},this.props,{language:this.state.language})),React.createElement(SimilarTitles,null),React.createElement(Footer,null));}});module.exports=App; /***/}, /* 160 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var MyAccount=React.createClass({displayName:"MyAccount",render:function render(){return React.createElement("div",{className:"my-account modal"},React.createElement("div",{className:"ui grid"},React.createElement("div",{className:"two column row account-settings"},React.createElement("div",{className:"twelve wide column"},React.createElement("h3",null,"Profile"),React.createElement("div",{className:"ui grid"},React.createElement("div",{className:"ui two column row"},React.createElement("div",{className:"three wide computer five wide tablet column"},React.createElement("div",{className:"ui text"},"First Name")),React.createElement("div",{className:"three wide computer five wide tablet column"},React.createElement("div",{className:"ui text"},"Last Name"))),React.createElement("div",{className:"ui two column row"},React.createElement("div",{className:"three wide computer five wide tablet column"},React.createElement("div",{className:"ui text"},"Keiichi")),React.createElement("div",{className:"three wide computer five wide tablet column"},React.createElement("div",{className:"ui text"},"Lindley"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"Email Address"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"keiichi.lindley@gmail.com"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"Password"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"*******"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"ZIP Code"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"80110"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"Phone Number"))),React.createElement("div",{className:"ui one column row"},React.createElement("div",{className:"five wide computer eight wide tablet column"},React.createElement("div",{className:"ui text"},"###-###-####"))))),React.createElement("div",{className:"four wide column"},React.createElement("a",{href:"#"},React.createElement("h4",null,"Profile")),React.createElement("a",{href:"#"},React.createElement("h4",null,"Notifications")),React.createElement("a",{href:"#"},React.createElement("h4",null,"Settings")),React.createElement("a",{href:"#"},React.createElement("h4",null,"Sign Out"))))));}});module.exports=MyAccount; /***/}, /* 161 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var WatchlistGrid=__webpack_require__(162);var MyWatchlist=React.createClass({displayName:"MyWatchlist",render:function render(){return React.createElement("div",{className:"my-watchlist modal"},React.createElement("div",{className:"ui grid"},React.createElement("div",{className:"two column row account-settings"},React.createElement("div",{className:"twelve wide column"},React.createElement("h3",null,"Watchlist"),React.createElement(WatchlistGrid,null)),React.createElement("div",{className:"four wide column"},React.createElement("a",{href:"#"},React.createElement("h4",null,"Watchlist")),React.createElement("a",{href:"#"},React.createElement("h4",null,"Continue Watching"))))));}});module.exports=MyWatchlist; /***/}, /* 162 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var WatchlistGrid=React.createClass({displayName:"WatchlistGrid",render:function render(){return React.createElement("div",{className:"ui vertical center container details my-watchlist grids"},React.createElement("div",{className:"ui equal width grid container bottom-padding"},React.createElement("div",{className:"row"},React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview thumb",style:{"backgroundImage":'url(/images/melody/M21031.jpg) !important'}},React.createElement("div",{className:"ui bottom attached label"},"El Sayed Abo El Araby Wasal"))),React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview thumb",style:{"backgroundImage":'url(/images/melody/M21032.jpg) !important'}},React.createElement("div",{className:"ui bottom attached label"},"Losoos Khamas Nogoom"))),React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview thumb",style:{"backgroundImage":'url(/images/melody/M22016.jpg) !important'}},React.createElement("div",{className:"ui bottom attached label"},"Dalou3a Ya Beih"))))));}});module.exports=WatchlistGrid; /***/}, /* 163 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Nav=React.createClass({displayName:"Nav",render:function render(){var menu=languageMenu(this.props.language);return React.createElement("div",null,React.createElement("div",{className:"ui large top fixed hidden menu inverted"},React.createElement("div",{className:"sidebar"}),React.createElement("div",{className:"ui container nav"},React.createElement("a",{href:"/",className:"item"},React.createElement("img",{src:"/images/melody-logo.png",className:"ui tiny image"})),React.createElement("a",{href:"/movies",className:"item"},"Movies"),React.createElement("a",{href:"/series",className:"item"},"Series"),React.createElement("a",{href:"/music",className:"item"},"Music"),React.createElement("a",{href:"/plays",className:"item"},"Plays"),React.createElement("a",{className:"item"},"Classics"),React.createElement("a",{className:"item"},"Collections"),React.createElement("a",{href:"/live",className:"item"},"Live TV"),React.createElement("div",{className:"ui category search item nav-search"},React.createElement("div",{className:"ui transparent icon input"},React.createElement("input",{type:"text",placeholder:"Search...",className:"prompt"}),React.createElement("i",{className:"search link icon"})),React.createElement("div",{className:"results"})),React.createElement("div",{className:"right menu"},React.createElement("div",{id:"account-dropdown",className:"ui left dropdown item"},React.createElement("i",{className:"setting icon"}),React.createElement("div",{className:"menu"},React.createElement("a",{className:"item",onClick:this.myAccount},React.createElement("i",{className:"user icon"}),React.createElement("span",{className:"text"},"My Account")),React.createElement("a",{className:"item",onClick:this.myWatchlist},React.createElement("i",{className:"list layout icon"}),React.createElement("span",{className:"text"},"Watchlist")),React.createElement("a",{className:"item",onClick:this.props.setLanguage.bind(null,menu.lang)},React.createElement("i",{className:"flag icon"}),React.createElement("span",{className:"text"},menu.name))))))),React.createElement("div",{id:"nav-sidebar",className:"ui right vertical sidebar menu"}," ",React.createElement("a",{href:"/",className:"item"},"Home"),React.createElement("a",{href:"/movies",className:"item"},"Movies"),React.createElement("a",{href:"/series",className:"item"},"Series"),React.createElement("a",{href:"/music",className:"item"},"Music"),React.createElement("a",{href:"/plays",className:"item"},"Plays"),React.createElement("a",{className:"item"},"Classics"),React.createElement("a",{className:"item"},"Collections"),React.createElement("a",{href:"/live",className:"item"},"Live TV"),React.createElement("div",{className:"ui category search item"},React.createElement("div",{className:"ui transparent icon input"},React.createElement("input",{type:"text",placeholder:"Search...",className:"prompt"}),React.createElement("i",{className:"search link icon"})),React.createElement("div",{className:"results"})),React.createElement("a",{className:"item horizontal divider"}),React.createElement("a",{className:"item",onClick:this.handleClick},React.createElement("h6",null,"My Account")),React.createElement("a",{className:"item"},React.createElement("h6",null,"Watchlist")),React.createElement("a",{className:"sidebar item"},React.createElement("h6",null,"Arabic"))),React.createElement("div",{className:"ui inverted vertical masthead center aligned"},React.createElement("div",{className:"ui container nav-header pad-bottom-tiny"},React.createElement("div",{className:"ui large secondary inverted pointing menu"},React.createElement("a",{className:"toc item right aligned"},React.createElement("i",{className:"sidebar icon"}))))));},myAccount:function myAccount(){$('.my-account.modal').modal('show');},myWatchlist:function myWatchlist(){$('.my-watchlist.modal').modal('show');}});var languageMenu=function languageMenu(lang){switch(lang){case 'ar':return {name:'English',lang:'en'};break;default:return {name:'Arabic',lang:'ar'};}};module.exports=Nav; /***/}, /* 164 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Roles=__webpack_require__(165);var VideoDetail=React.createClass({displayName:"VideoDetail",getInitialState:function getInitialState(){return {movie:''};},componentDidMount:function componentDidMount(){this.fetch=$.get('http://dgzn.io:8080/v1/assets'+this.props.source,function(result){this.setState({movie:result});}.bind(this));},componentWillUnmount:function componentWillUnmount(){this.fetch.abort();},render:function render(){var _this=this;var movie={name:'',description:'',productionYear:'Produced '+this.state.movie['production_year'],duration:0,player:''};if(this.state.movie){var _roles=this.state.movie.roles;var roles=[];this.state.movie.people.map(function(person){roles[_roles[person.role].meta[_this.props.language].name]=roles[_roles[person.role].meta[_this.props.language].name]||[];roles[_roles[person.role].meta[_this.props.language].name].push(person);});var movie={name:this.state.movie.meta[this.props.language].name,description:this.state.movie.meta[this.props.language].description,productionYear:'Produced '+this.state.movie['production_year'],duration:Math.floor(this.state.movie.duration/60)+' min',player:this.getPlayer(this.state.movie['video_url']),roles:roles};}return React.createElement("div",{className:"ui vertical center container aligned grids pad-top-medium"},React.createElement("div",{className:"ui vertical center container aligned grids pad-top-medium"},React.createElement("div",{className:"ui two column grid container"},React.createElement("div",{className:"details sixteen wide tablet eight wide computer column centered",dangerouslySetInnerHTML:{__html:movie.player}}),React.createElement("div",{className:"details sixteen wide tablet eight wide computer column centered"},React.createElement("img",{src:"/images/banner01.png",className:"ui image"}),React.createElement("h2",null,movie.name),React.createElement("h4",null,movie.description),React.createElement("div",{className:"ui one column grid center"},React.createElement("div",{className:"row"},React.createElement("div",{className:"column tight"},React.createElement("div",{className:"movie-details"},React.createElement("span",null,movie.duration),React.createElement("span",null,movie.productionYear)),React.createElement("div",{className:"movie-actions"},React.createElement("img",{src:"/images/play-button.png",className:"ui image"}),React.createElement("img",{src:"/images/add-button.png",className:"ui image"}),React.createElement("img",{src:"/images/social-share-circle-icons.png",className:"ui image social-share"}))))))),React.createElement("div",{className:"ui grid container details"},React.createElement("div",{className:"details sixteen wide tablet sixteen wide computer column centered"},React.createElement(Roles,{roles:movie.roles,language:this.props.language})))));},getPlayer:function getPlayer(url){console.log("getting player url",url);if(url.indexOf('youtube')>=0)return YouTubePlayer(url.split('v=')[1]);if(url.indexOf('bctid'))return BrightCovePlayer(url.split('&bctid=')[1]);}});function YouTubePlayer(id){return '<iframe width="98%" height="407" src="https://www.youtube.com/embed/'+id+'?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>';}function BrightCovePlayer(id){console.log("BrightcoveID",id);return '<object id="flashObj" width="98%" height="407" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,47,0"> \
	    ...
	    </embed></object>';}module.exports=VideoDetail; /***/}, /* 165 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var People=__webpack_require__(166);var Roles=React.createClass({displayName:"Roles",getInitialState:function getInitialState(){return {roles:[]};},componentWillReceiveProps:function componentWillReceiveProps(props){this.setState({roles:props['roles']||[],people:[]});},render:function render(){var PEOPLE=this.state.people;if(this.state.roles){var PEOPLE=[];for(var role in this.state.roles){PEOPLE.push(React.createElement(People,React.__spread({key:role,title:role,people:this.state.roles[role],language:this.props.language},this.props)));}}return React.createElement("div",{className:"ui three column grid container stackable"},PEOPLE);}});module.exports=Roles; /***/}, /* 166 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Person=__webpack_require__(167);var People=React.createClass({displayName:"People",getInitialState:function getInitialState(){return {title:this.props.title,people:this.props.people||[]};},render:function render(){var _this2=this;var people=[];var colWidth=this.props.colWidth?this.props.colWidth:'three';this.state.people.map(function(person,i){people.push(React.createElement(Person,{key:i,name:person.meta[_this2.props.language]["first_name"]+' '+person.meta[_this2.props.language]["last_name"]}));});var className='cast '+colWidth+' wide computer five wide tablet column tight';return React.createElement("div",{className:className},React.createElement("div",{className:"ui top attached label detailHeading"},this.state.title),React.createElement("div",{className:"ui grid"},React.createElement("div",{className:"row"},React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta values tight"},people)))));}});function getChararcters(){return React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta tight"},React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma"),React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma")));}module.exports=People; /***/}, /* 167 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Person=React.createClass({displayName:"Person",render:function render(){return React.createElement("li",null,this.props.name);}});module.exports=Person; /***/}, /* 168 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var SimilarTitles=React.createClass({displayName:"SimilarTitles",render:function render(){return React.createElement("div",{className:"ui vertical center container details grids"},React.createElement("div",{className:"ui one column grid container"},React.createElement("div",{className:"column header"},React.createElement("h4",{className:"ui header grid-title"},React.createElement("br",null),"Similar Titles"))),React.createElement("div",{className:"ui equal width grid container bottom-padding"},React.createElement("div",{className:"row"},React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview"},React.createElement("div",{className:"ui bottom attached label"},"Khally Balak Men Geranak"))),React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview"},React.createElement("div",{className:"ui bottom attached label"},"Khally Balak Men Geranak"))),React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview"},React.createElement("div",{className:"ui bottom attached label"},"Khally Balak Men Geranak"))),React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview"},React.createElement("div",{className:"ui bottom attached label"},"Khally Balak Men Geranak"))),React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview"},React.createElement("div",{className:"ui bottom attached label"},"Khally Balak Men Geranak")))),React.createElement("div",{className:"row"},React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview"},React.createElement("div",{className:"ui bottom attached label"},"Khally Balak Men Geranak"))),React.createElement("a",{className:"image preview"},React.createElement("div",{className:"image preview"},React.createElement("div",{className:"ui bottom attached label"},"Khally Balak Men Geranak"))))));}});module.exports=SimilarTitles; /***/}, /* 169 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Footer=React.createClass({displayName:"Footer",render:function render(){return React.createElement("div",{className:"ui inverted vertical footer stackable center aligned segment"},React.createElement("div",{className:"ui middle aligned six column centered stackable grid footer container"},React.createElement("div",{className:"row"},React.createElement("div",{className:"column middle aligned"},React.createElement("a",{className:"link"},React.createElement("h4",null,"FAQ/Help"))),React.createElement("div",{className:"column middle aligned"},React.createElement("a",{className:"link"},React.createElement("h4",null,"Jobs"))),React.createElement("div",{className:"column middle aligned"},React.createElement("a",{className:"link"},React.createElement("h4",null,"Terms of Use"))),React.createElement("div",{className:"column middle aligned"},React.createElement("a",{className:"link"},React.createElement("h4",null,"Privacy Policy"))),React.createElement("div",{className:"column middle aligned"},React.createElement("a",{className:"link"},React.createElement("h4",null,"Copyright"))),React.createElement("div",{className:"column middle aligned"},React.createElement("a",{className:"link"},React.createElement("h4",null,"Closed Captioning"))))),React.createElement("div",{className:"ui middle aligned one column centered stackable grid container"},React.createElement("div",{className:"ui image social-share"},React.createElement("img",{src:"/images/social-share.png"}))),React.createElement("div",{className:"ui middle aligned one column centered stackable grid container"},React.createElement("h6",{className:"tagline"},"© Melody Entertainment Group. All Rights Reserved. Lorem ipsum dolor sit amet, consectetur adipisicing elit")));}});module.exports=Footer; /***/}, /* 170 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var GridFilter=__webpack_require__(171);var Column=__webpack_require__(172);var Grid=React.createClass({displayName:"Grid",filter:function filter(_filter){this.setState({filter:_filter});},filterGenre:function filterGenre(genre){this.setState({genre:genre});},getInitialState:function getInitialState(){return {genre:'',collection:[],rows:this.props.rows||1};},componentDidMount:function componentDidMount(){this.fetch=$.get('http://dgzn.io:8080/v1/assets'+this.props.source,function(result){this.setState({collection:result});}.bind(this));},componentWillUnmount:function componentWillUnmount(){this.fetch.abort();},render:function render(){var _this3=this;var ROWS=[];var COLUMNS=[];var collection=this.state.collection;if(this.state.filter){switch(this.state.filter){case 'a-z':var collection=this.state.collection.sort(function(a,b){if(a.meta[_this3.props.language].name<b.meta[_this3.props.language].name)return -1;if(a.meta[_this3.props.language].name>b.meta[_this3.props.language].name)return 1;return 0;});break;case 'new':var collection=this.state.collection.sort(function(a,b){return b.id-a.id;});break;}}collection.some(function(data,i){if(_this3.state.genre[_this3.props.language]){if(data.genres){data.genres.some(function(genre){if(genre.meta[_this3.props.language].name==_this3.state.genre[_this3.props.language].name){COLUMNS.push(React.createElement(Column,React.__spread({key:'col-'+data.id,data:data},_this3.props)));return true;}});}}else {COLUMNS.push(React.createElement(Column,React.__spread({key:'col-'+data.id,data:data},_this3.props)));}if(COLUMNS.length==_this3.props.limit){ROWS.push(React.createElement("div",{className:"row"},COLUMNS));COLUMNS=[];}return ROWS.length===_this3.props.rows;});if(!ROWS.length){ROWS.push(React.createElement("div",{className:"row"},COLUMNS));}return React.createElement("div",null,React.createElement(GridFilter,React.__spread({},this.props,{filter:this.filter,filterGenre:this.filterGenre,activeFilter:this.state.filter,activeGenre:this.state.genre})),React.createElement("div",{className:"ui vertical center container aligned grids"},React.createElement("div",{className:"ui equal width grid container"},ROWS)));}});module.exports=Grid; /***/}, /* 171 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var GridFilter=React.createClass({displayName:"GridFilter",getInitialState:function getInitialState(){return {filter:'',genres:[]};},componentDidMount:function componentDidMount(){this.fetch=$.get('http://dgzn.io:8080/v1/assets/sets/Genres',function(genres){this.setState({genres:genres['sets']});}.bind(this));},componentWillUnmount:function componentWillUnmount(){this.fetch.abort();},render:function render(){var _this4=this;var title=this.props.activeGenre[this.props.language]?this.props.activeGenre[this.props.language].name:'Genres';var GENRES=[];this.state.genres.map(function(genre,i){if(genre.meta[_this4.props.language]){var name=genre.meta[_this4.props.language].name;GENRES.push(React.createElement("a",{className:"item",key:i*Math.random(9,99),onClick:_this4.props.filterGenre.bind(null,genre.meta)}," ",name));}});return React.createElement("div",{className:"ui container grids pad-bottom-medium"},React.createElement("div",{className:"row subnav"},React.createElement("span",{className:"title"},this.props.title),React.createElement("div",{id:"seasons-dropdown",className:"ui simple dropdown item inverted"},title," ",React.createElement("i",{className:"plus icon"}),React.createElement("div",{className:"menu"},GENRES)),React.createElement("div",{id:"seasons-dropdown",className:"ui simple dropdown item inverted"},"SORT BY ",React.createElement("i",{className:"plus icon"}),React.createElement("div",{className:"menu"},React.createElement("a",{className:"item",onClick:this.props.filter.bind(null,'featured')},"FEATURED"),React.createElement("a",{className:"item",onClick:this.props.filter.bind(null,'a-z')},"A -Z"),React.createElement("a",{className:"item",onClick:this.props.filter.bind(null,'new')},"JUST ADDED"),React.createElement("a",{className:"item",onClick:this.props.filter.bind(null,'top')},"TOP")))));}});module.exports=GridFilter; /***/}, /* 172 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Column=React.createClass({displayName:"Column",getInitialState:function getInitialState(){return {language:this.props.language?this.props.language:'en'};},componentWillReceiveProps:function componentWillReceiveProps(props){this.setState({language:props.language?props.language:'en'});},render:function render(){this.props.href?link=generateLink(this.props):link=this.props.href;var thumb='/images/melody/'+this.props.data.thumb.replace('M1','M11');if(this.props.thumbPath){thumb='/images/wireframe/16x9.png';}return React.createElement("a",{href:link||'#',className:"image preview"},React.createElement("div",{className:"image preview thumb",style:{"backgroundImage":'url('+thumb+') !important'}},React.createElement("div",{className:"ui bottom attached label"},this.props.data.meta[this.state.language].name)));},componentDidMount:function componentDidMount(){ //console.log("Grid > Row > Column [Properties]", this.props)
}});function generateLink(props){var link=props.href;var keys=props.href.match(/[:]\w+/g);keys.map(function(key){var _key=key.replace(':','');if(props.data[_key]){link=link.replace(key,props.data[_key]);}});return link;}module.exports=Column; /***/}, /* 173 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var MyAccount=__webpack_require__(160);var MyWatchlist=__webpack_require__(161);var Nav=__webpack_require__(163);var Grid=__webpack_require__(170);var SimilarTitles=__webpack_require__(168);var Footer=__webpack_require__(169);var GridApp=React.createClass({displayName:"GridApp",setLanguage:function setLanguage(lang){this.setState({language:lang});},getInitialState:function getInitialState(){return {language:'en'};},render:function render(){return React.createElement("div",null,React.createElement(MyAccount,null),React.createElement(MyWatchlist,null),React.createElement(Nav,{setLanguage:this.setLanguage,language:this.state.language}),React.createElement(Grid,React.__spread({},this.props,{language:this.state.language})),React.createElement(Footer,null));}});module.exports=GridApp; /***/}, /* 174 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var MyAccount=__webpack_require__(160);var MyWatchlist=__webpack_require__(161);var Nav=__webpack_require__(163);var Carousel=__webpack_require__(175);var Footer=__webpack_require__(169);var HomeApp=React.createClass({displayName:"HomeApp",setLanguage:function setLanguage(lang){this.setState({language:lang});},getInitialState:function getInitialState(){return {language:'en'};},render:function render(){return React.createElement("div",null,React.createElement(MyAccount,null),React.createElement(MyWatchlist,null),React.createElement(Nav,{setLanguage:this.setLanguage,language:this.state.language}),React.createElement("div",{className:"ui container hero"},React.createElement("div",{id:"img",className:"ui image hero"})),React.createElement("div",{className:"ui vertical center container aligned grids"},React.createElement(Carousel,{title:"Movies",source:"/movies",limit:"5",href:"/movies/:id"}),React.createElement(Carousel,{title:"Series",source:"/series",limit:"5",href:"/series/:id"}),React.createElement(Carousel,{title:"Plays",source:"/plays",limit:"5",href:"/plays/:id"})),React.createElement(Footer,null));}});module.exports=HomeApp; /***/}, /* 175 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Row=__webpack_require__(176);var Carousel=React.createClass({displayName:"Carousel",render:function render(){return React.createElement("div",null,React.createElement("div",{className:"ui one column grid container"},React.createElement("div",{className:"column header"},React.createElement("a",{href:'/'+this.props.title},React.createElement("h4",{className:"ui header grid-title"},React.createElement("br",null),this.props.title," >")))),React.createElement("div",{className:"ui equal width grid container"},React.createElement(Row,{source:this.props.source,limit:this.props.limit,href:this.props.href})));}});module.exports=Carousel; /***/}, /* 176 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Column=__webpack_require__(172);var Row=React.createClass({displayName:"Row",getInitialState:function getInitialState(){return {collection:[]};},componentDidMount:function componentDidMount(){this.fetch=$.get('http://dgzn.io:8080/v1/assets'+this.props.source,function(result){this.setState({collection:result});}.bind(this));},componentWillUnmount:function componentWillUnmount(){this.fetch.abort();},render:function render(){var _this5=this;var COLUMNS=[];this.state.collection.some(function(data,i){COLUMNS.push(React.createElement(Column,{key:i,data:data,href:_this5.props.href}));return i===_this5.props.limit-1;});return React.createElement("div",{className:"row"},COLUMNS);}});module.exports=Row; /***/}, /* 177 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var MyAccount=__webpack_require__(160);var MyWatchlist=__webpack_require__(161);var SeasonNav=__webpack_require__(178);var SeasonDetail=__webpack_require__(179);var SimilarTitles=__webpack_require__(168);var Footer=__webpack_require__(169);var SeasonApp=React.createClass({displayName:"SeasonApp",setLanguage:function setLanguage(lang){this.setState({language:lang});},getInitialState:function getInitialState(){return {language:'en'};},render:function render(){return React.createElement("div",null,React.createElement(MyAccount,null),React.createElement(MyWatchlist,null),React.createElement(SeasonNav,{setLanguage:this.setLanguage,language:this.state.language}),React.createElement(SeasonDetail,React.__spread({},this.props,{language:this.state.language})),React.createElement(Footer,null));}});module.exports=SeasonApp; /***/}, /* 178 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var SeasonNav=React.createClass({displayName:"SeasonNav",render:function render(){var menu=languageMenu(this.props.language);return React.createElement("div",null,React.createElement("div",{className:"ui large top fixed hidden menu inverted"},React.createElement("div",{className:"sidebar"}),React.createElement("div",{className:"ui container nav"},React.createElement("a",{href:"/",className:"item"},React.createElement("img",{src:"/images/melody-logo.png",className:"ui tiny image"})),React.createElement("a",{href:"/movies",className:"item"},"Movies"),React.createElement("a",{href:"/series",className:"item"},"Series"),React.createElement("a",{href:"/music",className:"item"},"Music"),React.createElement("a",{href:"/plays",className:"item"},"Plays"),React.createElement("a",{className:"item"},"Classics"),React.createElement("a",{className:"item"},"Collections"),React.createElement("a",{href:"/live",className:"item"},"Live TV"),React.createElement("div",{className:"ui category search item nav-search"},React.createElement("div",{className:"ui transparent icon input"},React.createElement("input",{type:"text",placeholder:"Search...",className:"prompt"}),React.createElement("i",{className:"search link icon"})),React.createElement("div",{className:"results"})),React.createElement("div",{className:"right menu"},React.createElement("div",{id:"account-dropdown",className:"ui left dropdown item"},React.createElement("i",{className:"setting icon"}),React.createElement("div",{className:"menu"},React.createElement("a",{className:"item",onClick:this.myAccount},React.createElement("i",{className:"user icon"}),React.createElement("span",{className:"text"},"My Account")),React.createElement("a",{className:"item",onClick:this.myWatchlist},React.createElement("i",{className:"list layout icon"}),React.createElement("span",{className:"text"},"Watchlist")),React.createElement("a",{className:"item",onClick:this.props.setLanguage.bind(null,menu.lang)},React.createElement("i",{className:"flag icon"}),React.createElement("span",{className:"text"},menu.name))))))),React.createElement("div",{id:"nav-sidebar",className:"ui right vertical sidebar menu"}," ",React.createElement("a",{href:"/",className:"item"},"Home"),React.createElement("a",{href:"/movies",className:"item"},"Movies"),React.createElement("a",{href:"/series",className:"item"},"Series"),React.createElement("a",{href:"/music",className:"item"},"Music"),React.createElement("a",{href:"/plays",className:"item"},"Plays"),React.createElement("a",{className:"item"},"Classics"),React.createElement("a",{className:"item"},"Collections"),React.createElement("a",{href:"/live",className:"item"},"Live TV"),React.createElement("div",{className:"ui category search item"},React.createElement("div",{className:"ui transparent icon input"},React.createElement("input",{type:"text",placeholder:"Search...",className:"prompt"}),React.createElement("i",{className:"search link icon"})),React.createElement("div",{className:"results"})),React.createElement("a",{className:"item horizontal divider"}),React.createElement("a",{className:"item",onClick:this.handleClick},React.createElement("h6",null,"My Account")),React.createElement("a",{className:"item",onClick:this.myAccount},React.createElement("h6",null,"Watchlist")),React.createElement("a",{className:"sidebar item"},React.createElement("h6",null,"Arabic"))),React.createElement("div",{id:"watchlist-sidebar",className:"ui left vertical sidebar inverted menu"},React.createElement("div",{id:"seasons-dropdown-filter",className:"ui simple dropdown menu inverted"},"SEASON 1",React.createElement("i",{className:"plus icon"}),React.createElement("div",{className:"menu"},React.createElement("a",{className:"item"},"SEASON 2"),React.createElement("a",{className:"item"},"SEASON 3"),React.createElement("a",{className:"item"},"SEASON 4"),React.createElement("a",{className:"item"},"SEASON 5"),React.createElement("a",{className:"item"},"SEASON 6"))),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 12"),React.createElement("div",{className:"watchlist-pct"},"75%")),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 13"),React.createElement("div",{className:"watchlist-pct"},"30%")),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 14"),React.createElement("div",{className:"watchlist-pct"},"100%")),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 15"),React.createElement("div",{className:"watchlist-pct"},"0%")),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 16"),React.createElement("div",{className:"watchlist-pct"})),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 17"),React.createElement("div",{className:"watchlist-pct"})),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 18"),React.createElement("div",{className:"watchlist-pct"})),React.createElement("a",{className:"item"},React.createElement("i",{className:"play tiny icon watchlist-button no-margin"}),React.createElement("i",{className:"plus tiny icon watchlist-button"}),React.createElement("span",null,"Ep 19"),React.createElement("div",{className:"watchlist-pct"}))),React.createElement("div",{className:"ui inverted vertical masthead center aligned"},React.createElement("div",{className:"ui container nav-header"},React.createElement("div",{className:"ui large secondary inverted pointing menu"},React.createElement("a",{className:"watchlist item left aligned"},React.createElement("i",{className:"list layout icon"})),React.createElement("a",{className:"toc item right aligned"},React.createElement("i",{className:"sidebar icon"}))))));},myAccount:function myAccount(){$('.my-account.modal').modal('show');},myWatchlist:function myWatchlist(){console.log("showing my watchlist");$('.my-watchlist.modal').modal('show');}});var languageMenu=function languageMenu(lang){switch(lang){case 'ar':return {name:'English',lang:'en'};break;default:return {name:'Arabic',lang:'ar'};}};module.exports=SeasonNav; /***/}, /* 179 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var SeasonFilter=__webpack_require__(180);var SeasonWatchlist=__webpack_require__(181);var Roles=__webpack_require__(165);var SeasonDetail=React.createClass({displayName:"SeasonDetail",getInitialState:function getInitialState(){return {series:''};},componentDidMount:function componentDidMount(){this.fetch=$.get('http://dgzn.io:8080/v1/assets'+this.props.source,function(result){this.setState({series:result});}.bind(this));},componentWillUnmount:function componentWillUnmount(){this.fetch.abort();},render:function render(){var _this6=this;var series={name:'',description:'',thumb:'/images/wireframe/16x9.png',seasonText:'Season 1',productionYear:'',duration:0,seasons:[],episodes:[]};if(this.state.series){var _roles=this.state.series.seasons[0].roles;var roles=[];this.state.series.seasons[0].people.map(function(person){roles[_roles[person.role].meta[_this6.props.language].name]=roles[_roles[person.role].meta[_this6.props.language].name]||[];roles[_roles[person.role].meta[_this6.props.language].name].push(person);});var series={name:this.state.series.meta[this.props.language].name,description:this.state.series.meta[this.props.language].description,thumb:'/images/melody/'+this.state.series.thumb.replace('M1','M11'),seasonText:'Season 1',productionYear:'Released '+this.state.series['production_year'],duration:Math.floor(this.state.series.seasons[0].episodes[0].duration/60)+' min',seasons:this.state.series.seasons,episodes:this.state.series.seasons[0].episodes,roles:roles};}setTimeout(function(){$('#watchlist-sidebar').sidebar('attach events','.watchlist.item');},1000);return React.createElement("div",null,React.createElement("div",{className:"ui container grids"},React.createElement(SeasonFilter,{title:series.name,seasons:series.seasons})),React.createElement("div",{className:"ui vertical center container aligned grids"},React.createElement("div",{className:"ui two column grid container details pad-top-medium"},React.createElement("div",{className:"details six wide computer only column centered season-watchlist"},React.createElement(SeasonWatchlist,{language:this.props.language,episodes:series.episodes})),React.createElement("div",{className:"details sixteen wide tablet seven wide computer column centered"},React.createElement("div",{id:"video-slide-out"}),React.createElement("img",{src:series.thumb,className:"ui huge image pad-right-small"}),React.createElement("h1",null,series.name),React.createElement("h3",null,series.seriesText),React.createElement("h4",{className:"pad-right-medium"},series.description),React.createElement("div",{className:"ui one column grid center"},React.createElement("div",{className:"row"},React.createElement("div",{className:"column tight"},React.createElement("div",{className:"movie-details"},React.createElement("span",null,series.duration),React.createElement("span",null,series.productionYear)),React.createElement("div",{className:"movie-actions"},React.createElement("img",{src:"/images/play-button.png",className:"ui image"}),React.createElement("img",{src:"/images/add-button.png",className:"ui image"}),React.createElement("img",{src:"/images/social-share-circle-icons.png",className:"ui image social-share"})))))),React.createElement("div",{className:"details sixteen wide tablet three wide computer column centered"},React.createElement(Roles,{roles:series.roles,language:this.props.language,colWidth:"sixteen"})))));}});module.exports=SeasonDetail; /***/}, /* 180 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var SeasonFilter=React.createClass({displayName:"SeasonFilter",render:function render(){var SEASONS=[];this.props.seasons.map(function(season,i){SEASONS.push(React.createElement("a",{key:i,className:"item"},"SEASON ",i+1));});return React.createElement("div",{className:"row subnav"},React.createElement("span",{className:"title"},"Series ",this.props.title," season 1"),React.createElement("div",{id:"seasons-dropdown",className:"ui simple dropdown item inverted"},"SEASON 1",React.createElement("i",{className:"plus icon"}),React.createElement("div",{className:"menu"},SEASONS)));}});module.exports=SeasonFilter; /***/}, /* 181 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var ReactDOM=__webpack_require__(158);var VideoPlayer=__webpack_require__(182);var SeasonWatchlist=React.createClass({displayName:"SeasonWatchlist",render:function render(){var _this7=this;var ROWS=[];if(!this.props.episodes)return React.createElement("div",{className:"row watchlist"});this.props.episodes.map(function(episode,i){ROWS.push(React.createElement(WatchlistRow,{key:'watchlist-'+i,episode:episode,language:_this7.props.language}));});return React.createElement("div",{className:"ui stackable grid"},ROWS);},componentDidMount:function componentDidMount(){console.log("Grid > Row > Watchlist [Properties]",this.props);}});var WatchlistRow=React.createClass({displayName:"WatchlistRow",render:function render(){return React.createElement("div",{className:"row watchlist"},React.createElement("div",{className:"sixteen wide tablet four wide computer column tight-right"},React.createElement("i",{className:"play large icon watchlist-button tight",onClick:this.playEpisode}),React.createElement("i",{className:"plus icon watchlist-button"}),React.createElement("span",{className:"watchlist-button"},"Ep ",this.props.episode.episode_number)),React.createElement("div",{className:"sixteen wide tablet eleven wide computer column tight-left"},React.createElement("div",{className:"ui progress watchlist small error episode"},React.createElement("div",{className:"bar"}))));},playEpisode:function playEpisode(){ReactDOM.render(React.createElement(VideoPlayer,{video:this.props.episode,language:this.props.language}),document.getElementById('video-slide-out'));$('#video-slide-out').css({"top":"-110%","left":"0%","position":"absolute","width":"1000px","height":"100%","display":"block","opacity":"0.7","z-index":"1"}).delay(100).velocity({top:"-4.5%",opacity:"1"},900,"spring");}});function generateLink(props){var link=props.href;var keys=props.href.match(/[:]\w+/g);keys.map(function(key){var _key=key.replace(':','');if(props.data[_key]){link=link.replace(key,props.data[_key]);}});return link;}module.exports=SeasonWatchlist; /***/}, /* 182 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var VideoPlayer=React.createClass({displayName:"VideoPlayer",render:function render(){if(this.props.video){var video={duration:Math.floor(this.props.video.duration/60)+' min',player:this.getPlayer(this.props.video['video_url'])};}return React.createElement("div",{className:"ui vertical center container aligned grids pad-top-medium"},React.createElement("div",{className:"ui vertical center container aligned grids pad-top-medium"},React.createElement("div",{className:"ui one column grid container"},React.createElement("div",{className:"details column ",dangerouslySetInnerHTML:{__html:video.player}})),React.createElement("div",{className:"ui grid container details"},React.createElement("div",{className:"details sixteen wide tablet sixteen wide computer column centered",style:{height:"80px"}}))));},getPlayer:function getPlayer(url){if(url.indexOf('youtube')>=0)return YouTubePlayer(url.split('v=')[1]);if(url.indexOf('bctid'))return BrightCovePlayer(url.split('&bctid=')[1]);}});function YouTubePlayer(id){return '<iframe width="98%" height="510" src="https://www.youtube.com/embed/'+id+'?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>';}function BrightCovePlayer(id){return '<object id="flashObj" width="98%" height="407" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,47,0"> \
	      <param name="movie" value="http://c.brightcove.com/services/viewer/federated_f9?isVid=1&isUI=1" />                                                                                                          \
	      <param name="bgcolor" value="#FFFFFF" />                                                                                                                                                                    \
	      <param name="flashVars" value="videoId='+id+'&playerID=3815086849001&playerKey=AQ~~,AAADd9u4__E~,fHl6JWluMnctnUR7lsNevXxKfibpHuew&domain=embed&dynamicStreaming=true" />                             \
	      <param name="base" value="http://admin.brightcove.com" />                                                                                                                                                   \
	      ...
	      <param name="allowScriptAccess" value="always" /> \
	      <embed src="http://c.brightcove.com/services/viewer/federated_f9?isVid=1&isUI=1" bgcolor="#FFFFFF"  flashVars="videoId='+id+'&playerID=3815086849001&playerKey=AQ~~,AAADd9u4__E~,fHl6JWluMnctnUR7lsNevXxKfibpHuew&domain=embed&dynamicStreaming=true" base="http://admin.brightcove.com" name="flashObj" width="98%" height="407" seamlesstabbing="false" type="application/x-shockwave-flash" allowFullScreen="true" allowScriptAccess="always" swLiveConnect="true" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"> \
	    </embed></object>';}module.exports=VideoPlayer; /***/}, /* 183 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var AlbumWatchlist=__webpack_require__(184);var AlbumDetail=React.createClass({displayName:"AlbumDetail",getInitialState:function getInitialState(){return {album:''};},componentDidMount:function componentDidMount(){this.fetch=$.get('http://util.giantdev.com/v1/assets'+this.props.source,function(result){this.setState({album:result[0]});}.bind(this));},componentWillUnmount:function componentWillUnmount(){this.fetch.abort();},render:function render(){var album={name:'',description:'',albumText:'Album 1',songs:[]};if(this.state.album){var album={name:this.state.album.meta.en.name,description:this.state.album.meta.en.description,albumText:'Album 1',songs:this.state.album.songs};}return React.createElement("div",{className:"ui two column grid container details pad-top-medium"},React.createElement("div",{className:"details six wide computer only column centered"},React.createElement(AlbumWatchlist,{songs:album.songs})),React.createElement("div",{className:"details sixteen wide tablet seven wide computer column centered"},React.createElement("img",{src:"/images/wireframe/16x9.png",className:"ui huge image pad-right-small"}),React.createElement("h1",null,album.name),React.createElement("h3",null,album.albumText),React.createElement("h4",{className:"pad-right-medium"},album.description),React.createElement("div",{className:"ui one column grid center"},React.createElement("div",{className:"row"},React.createElement("div",{className:"column tight"},React.createElement("div",{className:"movie-details"},React.createElement("span",null,"R"),React.createElement("span",null,"123 min"),React.createElement("span",null,"5.1"),React.createElement("span",null,"HD")),React.createElement("div",{className:"movie-actions"},React.createElement("img",{src:"/images/play-button.png",className:"ui image"}),React.createElement("img",{src:"/images/add-button.png",className:"ui image"}),React.createElement("img",{src:"/images/social-share-circle-icons.png",className:"ui image social-share"})))))),React.createElement("div",{className:"details sixteen wide tablet three wide computer column centered"},React.createElement("div",{className:"ui three column grid container stackable"},React.createElement("div",{className:"cast sixteen wide computer five wide tablet column tight"},React.createElement("div",{className:"ui top attached label detailHeading"},"Producers"),React.createElement("div",{className:"ui grid"},React.createElement("div",{className:"row"},React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta tight"},React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma"),React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma"))),React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta values"},React.createElement("li",null,"Shiradashi Smith"),React.createElement("li",null,"Jane Doe"),React.createElement("li",null,"John Smit"),React.createElement("li",null,"Someone")))))),React.createElement("div",{className:"cast sixteen wide computer five wide tablet column tight"},React.createElement("div",{className:"ui top attached label detailHeading"},"Directors"),React.createElement("div",{className:"ui grid"},React.createElement("div",{className:"row"},React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta tight"},React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma"),React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma"),React.createElement("div",{className:"column"}))),React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta values"},React.createElement("li",null,"Shiradashi Smith"),React.createElement("li",null,"Jane Doe"),React.createElement("li",null,"John Smit"),React.createElement("li",null,"Someone")))))),React.createElement("div",{className:"cast sixteen wide computer five wide tablet column tight"},React.createElement("div",{className:"ui top attached label detailHeading"},"Cast & Crew"),React.createElement("div",{className:"ui grid"},React.createElement("div",{className:"row"},React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta tight"},React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma"),React.createElement("li",null,"Alex"),React.createElement("li",null,"Noma"))),React.createElement("div",{className:"pad-top-medium column tight"},React.createElement("ul",{className:"meta values"},React.createElement("li",null,"Shiradashi Smith"),React.createElement("li",null,"Jane Doe"),React.createElement("li",null,"John Smit"),React.createElement("li",null,"Someone")))))))));}});module.exports=AlbumDetail; /***/}, /* 184 */ /***/function(module,exports,__webpack_require__){var React=__webpack_require__(1);var Watchlist=React.createClass({displayName:"Watchlist",render:function render(){var ROWS=[];this.props.songs.map(function(episode,i){ROWS.push(React.createElement(WatchlistRow,{index:i+1,episode:episode}));});return React.createElement("div",{className:"ui stackable grid"},ROWS);},componentDidMount:function componentDidMount(){console.log("Grid > Row > Watchlist [Properties]",this.props);}});var WatchlistRow=React.createClass({displayName:"WatchlistRow",render:function render(){return React.createElement("div",{className:"row watchlist"},React.createElement("div",{className:"sixteen wide tablet four wide computer column tight-right"},React.createElement("i",{className:"play large icon watchlist-button"}),React.createElement("i",{className:"plus icon watchlist-button"}),React.createElement("span",{className:"watchlist-button"},"#",this.props.index)),React.createElement("div",{className:"sixteen wide tablet eleven wide computer column tight-left"},React.createElement("div",{className:"ui progress watchlist small error ep19"},React.createElement("div",{className:"bar"}))));}});function generateLink(props){var link=props.href;var keys=props.href.match(/[:]\w+/g);keys.map(function(key){var _key=key.replace(':','');if(props.data[_key]){link=link.replace(key,props.data[_key]);}});return link;}module.exports=Watchlist; /***/} /******/]);
